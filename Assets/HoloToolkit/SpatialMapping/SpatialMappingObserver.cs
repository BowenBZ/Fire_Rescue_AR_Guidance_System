...
namespace Academy.HoloToolkit.Unity
{
    ...
    public class SpatialMappingObserver : SpatialMappingSource
    {
        ...
        /// </summary>
        public event UnityEngine.VR.WSA.SurfaceObserver.SurfaceChangedDelegate SurfaceChanged;

        /// <summary>
        /// Event for hooking when the data for a surface is ready.
        /// </summary>
        public event UnityEngine.VR.WSA.SurfaceObserver.SurfaceDataReadyDelegate DataReady;
        ...
        /// </summary>
        private Queue<UnityEngine.VR.WSA.SurfaceData> surfaceWorkQueue = new Queue<UnityEngine.VR.WSA.SurfaceData>();
        ...
        private GameObject GetSurfaceObject(int surfaceID, Transform parentObject)
        {
            ...
            toReturn.AddComponent<UnityEngine.VR.WSA.WorldAnchor>();
